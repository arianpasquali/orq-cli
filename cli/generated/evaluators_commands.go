...
func registerevaluatorsCommands(root *cobra.Command) {
	evaluatorsCmd := &cobra.Command{
		Use:   "evaluators",
		Short: "Evaluators",
		Long:  bartolocli.Markdown("Evaluators"),
	}
	root.AddCommand(evaluatorsCmd)
